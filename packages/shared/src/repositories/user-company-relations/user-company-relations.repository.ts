...
export class UserCompanyRelationsRepository extends InMemoryRepository<UserCompanyRelationDocument, CreateUserCompanyRelationDocumentInput, UpdateUserCompanyRelationDocumentInput, QueryUserCompanyRelationsInput> {
